...
/**
 * GZZoneLogoText
 * Vector SVG implementation matching the official logo character anatomy:
 * Squircle geometry, heavy stems, blocky wide width, wedge apostrophe.
 */
export function GZZoneLogoText({ className = "h-6 w-auto", fillColor = "currentColor", ...props }: GZZoneLogoTextProps) {
  return (
    <svg
      viewBox="0 0 316 48"
      fill={fillColor}
      ...
      {...props}
    >
      {/* G - Squircle frame, deep horizontal crossbar extending inward from right stem */}
      ...
      {/* Z - Blocky diagonal with softened outer corners */}
      ...
      {/* Apostrophe (') - Angular, geometric wedge tilted high right */}
      ...
      {/* O - Squircle outer with high-contrast thick vertical sides */}
      ...
      {/* N - Parallel vertical stems with bold diagonal */}
      <path d="M 220 0 L 233 0 L 253 30 L 253 0 L 266 0 L 266 48 L 253 48 L 233 18 L 233 48 L 220 48 Z" />

      {/* E - Three parallel horizontal arms with vertical spine */}
